...
class ApplyToSquadBtn(View):
    ...
    def __init__(self, pid, sq, tag, lid):
        ...
        btn = Button(label="Apply", emoji="▶️", style=discord.ButtonStyle.success, custom_id=f"apply_{pid}")
...
class RecruitBtn(View):
    ...
    def __init__(self, pid, player_id):
        ...
        btn = Button(label="Recruit", emoji="▶️", style=discord.ButtonStyle.primary,
...
class MemberPanel(View):
    ...
    @discord.ui.button(label="Find Team", style=discord.ButtonStyle.success, emoji="⬅️", row=1)
    ...
    @discord.ui.button(label="Apply to Squad", style=discord.ButtonStyle.success, emoji="➡️", row=1)
...
class ModPanel(View):
    ...
    @discord.ui.button(label="Configure Roles", style=discord.ButtonStyle.secondary, emoji="⚙️", row=2)
    ...
    @discord.ui.button(label="Download Backup", style=discord.ButtonStyle.secondary, emoji="⬇️", row=3)
